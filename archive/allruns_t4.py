...
def highlight_navy_blue(cap):
    ...
    lower_navy_blue = np.array([0, 50, 133])  # Actually for gelatin breastphantom on hari's desk, adjust the lower bound based on your needs
    upper_navy_blue = np.array([50, 255, 200])  # Actually for gelatin breastphantom on hari's desk, adjust the upper bound based on your needs
