...
def main():
    ...
    function_names = ["Function 1, Welcome", "Function 2, Color Thresh", "Function 3, Save Mask", "Function 4, Base Calib", "Function 5 , Save Base", "Function 6, Imaging windows", "Function7, Save windows"]
    ...
    color_threshold_button = tk.Button(root, text="Perform skin detection", wraplength=50, command=color_threshold, font=("Helvetica", 8))
    ...
    base_calib_button = tk.Button(root, text="Start Baseline Calibration", command=base_calibration, font=("Helvetica", 8))
    ...
    save_relative_button = tk.Button(root, text=f"Save Base Position {positions_collected}", command=save_relative, font=("Helvetica", 8))
    save_relative_button.place(relx=0.5, rely=0.9, relheight=0.1, relwidth=0.2)

    #
    # # Button to change the filter function
    # switch_button = tk.Button(root, text="Next Function", command=next_function, font=("Helvetica", 14))
    # switch_button.pack()
